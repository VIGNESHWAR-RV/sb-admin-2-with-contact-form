...
function Contact() {
  ...
  const getQueries = () => {
    fetch("https://61c412daf1af4a0017d99281.mockapi.io/queries1", { method: "GET" })
  ...
  function Delete(id) {
    fetch(`https://61c412daf1af4a0017d99281.mockapi.io/queries1/${id}`, { method: "DELETE" })
      .then(response => response.json())
      .then(() => getQueries());
  };
  ...
  const AddQuery = (values) => {
    ...
    fetch("https://61c412daf1af4a0017d99281.mockapi.io/queries1",
      {
        method: "POST",
